...
#LOCAL_C_INCLUDES +=  $(IDTECH_DIR)/libzip $(IDTECH_DIR)/openssl $(IDTECH_DIR)/curl/include $(TOP_DIR)/../../Serial/jni/s-setup/
#LOCAL_STATIC_LIBRARIES += openssl opencrypto libcurl libzip
